...
_Линейка коков – это daily рейтинг чистого рандома\. Размеры генерируются случайно каждый день \(от 0 до 61 см\) и сбрасываются в полночь по МСК\. Никаких накоплений – только удача здесь и сейчас\!_

🎲 _Сегодня ты топ, завтра ты дно – рандом решает, кому повезло\!_`
...
_Гонка коков – это сезонное соревнование длиной 3 месяца\. Измеряй свой кок ежедневно, все результаты суммируются автоматически\. Побеждают три участника с максимальным накопленным размером за весь сезон\._

_С началом нового сезона все коки сбрасываются, и гонка начинается заново для всех\._

💡 Совет: _Измеряй кок каждый день, чтобы максимизировать свои шансы на победу\!_
...
_Ладдер коков – это твой вечный путь к славе\. Здесь суммируется каждый кок за всю историю твоего участия\. В отличие от дневной линейки и сезонной гонки, ладдер никогда не обнуляется\._

🔥 _Топ ладдера – это легенды, измеряющие коки с первого дня\. Стань одним из них\!_`
...
_Сезоны коков – это 3\-месячная битва за звание лучшего кокера\. Измеряй каждый день, суммируй результаты и борись за топ\-3\. Победители получают легендарные кок\-респекты™, которые можно обменять на мерч\!_

🔥 _История помнит только победителей – стань одним из них\!_`
