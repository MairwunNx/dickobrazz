...
Средний кок в системе \(5 дн.\): *%[3]s см* %[4]s
Медиана кока в системе \(5 дн.\): *%[5]s см* %[6]s

Соотношение коков \(5 дн.\): 💪 *%[19]s%%* 🤏 *%[20]s%%*
...
В среднем размер кока \(5 дн.\): *%[8]s см* %[9]s
...
%[17]s Средний дневной прирост \(5 дн.\): *%[18]s см/день*`
