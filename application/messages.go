...
Средний кок в системе \(10 дн\.\): *%[3]s см* %[4]s
Медиана кока в системе \(10 дн\.\): *%[5]s см* %[6]s

Соотношение коков \(10 дн\.\): 💪 *%[19]s%%* 🤏 *%[20]s%%*

📊 *Персональная динамика кока*

ИРК (Индекс Размера Кока): __*%[10]s*__
Коэффициент везения \(5 дн\.\): *%[28]s* %[29]s
Волатильность кока \(5 дн\.\): *%[30]s* %[31]s

Общий посчитанный кок: *%[7]s см* 🤯
В среднем размер кока \(10 дн\.\): *%[8]s см* %[9]s
...
%[17]s Средний дневной прирост \(10 дн\.\): *%[18]s см/день*`
