...
🤯 Внимание\! В рамках бессрочной акции *Zloy Cock* в объединении *Zloy Sport x Dickobrazz*, скачивай *Злой Спорт* из *Рустор* и тренируйся так, как будто качаешь не мышцы, а свой *кок* 💪`
...
⏱️ Период: *%[2]s - %[3]s*`
	...
	MsgCockSeasonTemplateFooter = `🌟 *Каждый сезон* соревнуются игроки, отправляя свои коки в течение определенного периода времени\! ⏱️

💯 Коки *суммируются* за период сезона\!

🥇 *Три участника* с наибольшим суммарным размером кока получают максимальные *кок-респекты™*\!`
