...
import "dickobrazz/src/shared/datetime"
...
// CockSizeData — ответ POST /api/v1/cock/size.
...
// CockRulerData — ответ GET /api/v1/cock/ruler.
...
// CockRaceData — ответ GET /api/v1/cock/race.
...
// CockLadderData — ответ GET /api/v1/cock/ladder.
...
// CockDynamicRecentStat — средние и медианные значения.
...
// CockDynamicGlobalRecord — глобальный рекорд.
